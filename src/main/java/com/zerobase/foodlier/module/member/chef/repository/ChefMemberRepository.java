...
public interface ChefMemberRepository extends JpaRepository<ChefMember, Long> {
    ...
    String baseAroundCountQuery = "SELECT count(*)\n" +
            "FROM chef_member c\n" +
            "JOIN member m ON m.chef_member_id = c.id\n" +
            "JOIN\n" +
            "(\n" +
    ...
    @Query(
            ...
            countQuery = baseAroundCountQuery,
            nativeQuery = true
    )
    Page<AroundChefDto> findAroundChefOrderByDistance(
            @Param("requester") Long memberId,
    ...
    Page<AroundChefDto> findAroundChefOrderByReview(
            @Param("requester") Long memberId,
            @Param("lat") double lat,
            @Param("lnt") double lnt,
            @Param("distance") double distance,
    ...
    Page<AroundChefDto> findAroundChefOrderByStar(
            @Param("requester") Long memberId,
            @Param("lat") double lat,
            @Param("lnt") double lnt,
            @Param("distance") double distance,
    ...
    Page<AroundChefDto> findAroundChefOrderByRecipeCount(
            @Param("requester") Long memberId,
            @Param("lat") double lat,
            @Param("lnt") double lnt,
            @Param("distance") double distance,
